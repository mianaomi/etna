...
/* package lightweight-0.1.0.0 */
#ifndef VERSION_lightweight
#define VERSION_lightweight "0.1.0.0"
#endif /* VERSION_lightweight */
#ifndef MIN_VERSION_lightweight
#define MIN_VERSION_lightweight(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lightweight */
...
#define CURRENT_COMPONENT_ID "lightweight-0.1.0.0-inplace-lightweight"
