...
def main():
    ...
    for dir in [raw, parsed, analyzed]: os.makedirs(dir, exist_ok=True)
    ...
    for workload in WORKLOADS:
        ...
        # create the plot
        Analysis.analyze(parsed, analyzed, [s.framework + s.strategy.capitalize() for s in STRATEGIES], [workload])
